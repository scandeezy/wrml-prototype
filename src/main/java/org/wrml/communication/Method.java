 ...
 */
public enum Method implements Unique<Method> {

    OPTIONS("OPTIONS", false, true), GET("GET", true, true), HEAD("HEAD", true, true), POST("POST", false, false), PUT(
            "PUT",
            false,
            true), DELETE("DELETE", false, true), TRACE("TRACE", false, true), CONNECT("CONNECT", false, false);
