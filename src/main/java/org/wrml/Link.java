...
public final class Link {
    ...
    public Model click(URI responseModelSchemaId, Model requestModel, List<String> hrefParams) {
        ...
        /*
         * Autogenerated subclasses of Model can have an generated method for
         * each combination of link relation and request/response Schema. Sort
         * of like Hibernate for the Web.
         * 
         * For example, this approach would imply that subclasses that
         * "implement" WRML's Document schema would have a getSelf() method in
         * Java, which under the covers would click a link to return the latest
         ...
         * schema ids within response media types), and optional request types
         * (as schema ids within request media types). This information can be
         * used at class generation time to produce methods that have names like
         * save or save(Story story) and getAuthor(). JavaBean method names are
         * generated from concat of link rel's method, name, and return schema
         ...
         * "Writer" being one of them. Java doesn't allow overloading the return
         ...
         * 
         * In cases where the LinkRelation accepts a request schema type that
         * this schema instance implements, the code generation should provide a
         * no-arg version of the method that internally passes this Model (the
         ...
         * over after the source schema fills in params with field values? It
         * would be cool if they could be used to generate clean params names
         * for Java methods that need to result in a client-controlled resource
         ...
         * public void delete();
         * 
         * An "unsafe" action (aka controller) method that was generated from a
         ...
         * directly to a REST API via WRML, with object caching in the JVM of
         * course.
         * 
         ...
         * services that support several different types. This design allows for
         * the same context interface to work for both client and server side
         ...
         * server side, the context may talk to a storage subsystem to CRUD wrml
        ...
        final Method method = rel.getMethod();
